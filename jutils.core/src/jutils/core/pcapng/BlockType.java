package jutils.core.pcapng;

import jutils.core.INamedValue;
import jutils.core.pcapng.blocks.CustomLocked;
import jutils.core.pcapng.blocks.CustomUnlocked;
import jutils.core.pcapng.blocks.DecryptionSecrets;
import jutils.core.pcapng.blocks.EnhancedPacket;
import jutils.core.pcapng.blocks.InterfaceDescription;
import jutils.core.pcapng.blocks.InterfaceStatistics;
import jutils.core.pcapng.blocks.NameResolution;
import jutils.core.pcapng.blocks.SectionHeader;
import jutils.core.pcapng.blocks.SimplePacket;
...
public enum BlockType implements INamedValue
{
    ...
    {
        return INamedValue.fromValue( value, BlockType.values(), UNKNOWN );
    }
}
