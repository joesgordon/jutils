 ...
 *
 ******************************************************************************/
public class VaxDouble
{
    /**  */
    public static final long SIGN_MASK = 1L << 63;
    /**  */
    public static final long EXPONENT_MASK = 0xFFL << 55;
    /**  */
    public static final long HIDDEN_BIT_MASK = 1L << 55;
    /**  */
    public static final long MANTISSA_MASK = HIDDEN_BIT_MASK - 1;
     ...
     * @return
     **************************************************************************/
    public static double calcVaxValue( boolean sign, long exponent,
        long mantissa )
    {
     ...
     * @return
     **************************************************************************/
    public static double calcVaxMantissa( long mantissa )
    {
     ...
     * @return
     **************************************************************************/
    public static double calcVaxMantissaScale( long mantissa )
    {
