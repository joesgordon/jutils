 ...
 * 
 ******************************************************************************/
public class SeedColorModel implements IColorModel
{
    /**  */
    private final int [] seeds;
    /**  */
    private final SeedColorConfig config;
    /**  */
     ...
     * @param bitDepth
     **************************************************************************/
    private SeedColorModel( int [] seeds, int bitDepth )
    {
        this.seeds = seeds;
        this.config = new SeedColorConfig();
     ...
     * 
     **************************************************************************/
    public static final class SeedColorConfig
    {
        /**  */
     ...
     * @return
     **************************************************************************/
    public static int [] createGrayscaleSeeds()
    {
    ...
    {
        int [] seeds = createGrayscaleSeeds();

        return new SeedColorModel( seeds, bitDepth );
    }

    /***************************************************************************
     * @return
     **************************************************************************/
    public static int [] createHotSeeds()
    {
     ...
     * @return
     **************************************************************************/
    public static IColorModel createHotMap( int bitDepth )
    {
        int [] seeds = createHotSeeds();
     ...
     * @return
     **************************************************************************/
    public static int [] createBlueGreenRedSeeds()
    {
     ...
     * @return
     **************************************************************************/
    public static IColorModel createBlueGreenRedMap( int bitDepth )
    {
        int [] seeds = createBlueGreenRedSeeds();
     ...
     * @return
     **************************************************************************/
    public static int [] createNightVisionSeeds()
    {
        int [] seeds = new int[256];
     ...
     * @return
     **************************************************************************/
    public static IColorModel createNightVisionMap( int bitDepth )
    {
        int [] seeds = createNightVisionSeeds();
     ...
     * @return
     **************************************************************************/
    public static int [] createCoolWarmSeeds()
    {
