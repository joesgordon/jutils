 ...
 * 
 ******************************************************************************/
public enum SecHdrTimeFormat implements INamedValue
{
    /**
     ...
     * @param name
     **************************************************************************/
    private SecHdrTimeFormat( int value, String name )
    {
        this.value = value;
        this.name = name;
    }
     ...
     * @return
     **************************************************************************/
    public static SecHdrTimeFormat fromValue( int value )
    {
     ...
     * @return
     **************************************************************************/
    public static SecHdrTimeFormat fromValue( byte value )
    {
